...
/// <summary>
/// A ScriptableObject-based variable that stores a list of Item items, 
...
public class InventoryVariable : ScriptableObject
{
    ...
    /// <summary>
    /// Returns the current list of Item items in the inventory.
    /// </summary>
    public InventoryController Value => _inventory;

    /// <summary>
    /// Updates the inventory with a new list of Item items.
    /// </summary>
